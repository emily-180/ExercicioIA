...
def gerarBuscarConsulta(consulta,dataset):
    ...
    embedding_consulta['embedding']) # Calculo de distancia entre consulta e base
...
def melhorarResposta(inputText):
    ...
    system_instruction=[
    types.Part.from_text(text="""Considere a consulta e resposta, reescreva as
    sentenças de resposta de uma forma alternativa, não apresente opções de
    reescrita"""),
    ],
    )
